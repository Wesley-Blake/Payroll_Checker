...
class TestOverTwelveHours:
    ...
    def test_over_twelve_hours_with_invalid_paths(self):
        ...
        with pytest.raises(KeyError):
            result = over_twleve_hours(pd.DataFrame(), pd.DataFrame())
    ...
    def test_over_twelve_hours_with_missing_email_file(self):
        ...
        with pytest.raises(KeyError):
            result = over_twleve_hours(
                pd.read_csv(Path("Payroll-Checker\\tests\\data_examples\\hours-breakdown.csv")),
                pd.DataFrame()
            )
    ...
    def test_over_twelve_hours_with_missing_hours_file(self):
        ...
        with pytest.raises(KeyError):
            result = over_twleve_hours(
                pd.DataFrame(),
                pd.read_csv(Path("Payroll-Checker\\tests\\data_examples\\emails.csv"))
            )
    ...
    def test_over_twelve_hours_below_threshold(self, tmp_path):
        ...
        result = over_twleve_hours(pd.read_csv(hours_file), pd.read_csv(emails_file))
        assert result == {}
